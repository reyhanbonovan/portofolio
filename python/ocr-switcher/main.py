...
from helpers.config import app_host, app_port, app_worker
...
if __name__ == "__main__":
    uvicorn.run("__main__:app", host=app_host, port=app_port, workers=app_worker)
