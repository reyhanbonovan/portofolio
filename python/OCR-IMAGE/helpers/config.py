...
app_worker = int(os.getenv('APP_WORKERS', "1"))
be_timeout  = int(os.getenv('PARAM_TIMEOUT', "10"))
param_service_name = os.getenv('PARAM_SVNAME', "") 
...
db_pool_increment = int(os.getenv('DB_POOL_INCREMENT', "10"))